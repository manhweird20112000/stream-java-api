...
import com.stream.livestreamservice.config.UseCaseConfig;
import com.stream.livestreamservice.infrastructure.web.response.ApiResponseBodyAdvice;
...
class AuthHealthControllerTests {
    ...
    void healthReturnsServiceStatus() throws Exception {
        mockMvc.perform(get("/api/auth/health"))
                ...
                .andExpect(jsonPath("$.data.service", is("livestream-service")))
